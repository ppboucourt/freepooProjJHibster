...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "freepoo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "freepoo API";

        private String description = "freepoo API documentation";
